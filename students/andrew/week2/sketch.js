...
function preload(){
  skills=loadTable("skills - week 2.csv", "loaded");
}
...
// TITLE //
  ...
  // FEEDBACK //
    ...
    fill(255, 150, 50, 255);
    text(skills.getString(1,3), 35,445);
    text(skills.getString(2,3), 35,470);
    text(skills.getString(3,3), 35,495);
    text(skills.getString(4,3), 35,525);
}
